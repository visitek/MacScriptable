-- Save the currently focused application BEFORE dialogs steal focus
tell application "System Events"
  set targetAppBundle to bundle identifier of first process whose frontmost is true
end tell
...
-- Show dialog with "cs", "en", "Close" buttons
...
-- Reactivate the original app and paste the text
if targetAppBundle is not missing value then
  try
    tell application id targetAppBundle to activate
  end try
  delay 0.3
end if
